...
TARGET_BOARD_INFO_FILE := device/samsung/epic4gtouchvzw/board-info.txt
...
TARGET_RECOVERY_INITRC := device/samsung/epic4gtouchvzw/recovery.rc
...
# Releasetools
TARGET_RELEASETOOL_OTA_FROM_TARGET_SCRIPT := ./device/samsung/epic4gtouchvzw/releasetools/epic4gtouchvzw_ota_from_target_files
TARGET_RELEASETOOL_IMG_FROM_TARGET_SCRIPT := ./device/samsung/epic4gtouchvzw/releasetools/epic4gtouchvzw_img_from_target_files

# Graphics
BOARD_EGL_CFG := device/samsung/epic4gtouchvzw/configs/egl.cfg
...
BOARD_CHARGER_RES := device/samsung/epic4gtouchvzw/res/charger
...
# Recovery
BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/samsung/epic4gtouchvzw/recovery/recovery_keys.c
BOARD_CUSTOM_GRAPHICS := ../../../device/samsung/epic4gtouchvzw/recovery/graphics.c
...
TARGET_SPECIFIC_HEADER_PATH := device/samsung/epic4gtouchvzw/include

# assert
TARGET_OTA_ASSERT_DEVICE := SPH-D710,epic4gtouch,epic4gtouchvzw
...
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/epic4gtouchvzw/shbootimg.mk
